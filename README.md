...
The contents of this repoistory conatain the frontend elements of the Document OCR Tool. The tool 
...
See related backend project: [Document-OCR-Backend](https://github.com/john-samis/Document-OCR-Backend)
